            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <section>
                        ...
                        <form method="post" action="{{ route('result.update', $result->id) }}" class="mt-6 space-y-6">
                            @csrf
                            @method('put')
                            ...
                            <div>
                                ...
                                <x-text-input id="gpa" name="gpa" type="number" class="mt-1 block w-full"
                                    autocomplete="gpa" value="{{ old('gpa', $result->gpa) }}" step="0.01" />
                                <x-input-error :messages="$errors->result->get('gpa', $result->gpa)" class="mt-2" />
                            </div>
