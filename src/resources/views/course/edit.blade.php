            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <section>
                        ...
                        <form method="post" action="{{ route('course.update', $course->id) }}" class="mt-6 space-y-6">
                            @csrf
                            @method('put')
                            ...
                            <div>
                                ...
                                <x-text-input id="name" name="name" type="text" class="mt-1 block w-full"
                                    autocomplete="name" value="{{ old('name', $course->name) }}" autofocus />
                            ...
                            <div>
                                ...
                                <x-text-input id="code" name="code" type="text" class="mt-1 block w-full"
                                    autocomplete="code" value="{{ old('code', $course->code) }}" />
                            ...
                            <div>
                                ...
                                <select id="semester_id" name="semester_id" required
                                    ...
                                    @foreach ($semesters as $semester)
                                        <option {{ $course->semester_id == $semester->id ? 'selected' : '' }}
