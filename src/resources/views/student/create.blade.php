                    ...
                    <section>
                        ...
                        <form method="post" enctype="multipart/form-data" action="{{ route('student.store') }}"
                            ...
                            <div>
                                ...
                                <x-input-error :messages="$errors->student->get('name')" class="mt-2" />
                            </div>

                            <div>
                                <x-input-label for="student_id" :value="__('Student ID')" />
                                <x-text-input id="student_id" name="student_id" type="text" class="block w-full mt-1"
                                    autocomplete="student_id" autofocus value="{{ old('student_id') }}" />
                            ...
                            <div>
                                ...
                                <x-text-input id="department" name="department" type="text" class="block w-full mt-1"
                                    autocomplete="department" value="{{ old('department') }}" />
                            ...
                            <div>
                                ...
                                <x-text-input id="session" name="session" type="text" class="block w-full mt-1"
                                    autocomplete="session" value="{{ old('session') }}" />
                            ...
                            <div>
                                ...
                                <x-text-input id="cgpa" name="cgpa" type="number" class="block w-full mt-1"
                                    autocomplete="cgpa" step="0.01" value="{{ old('cgpa') }}" />
